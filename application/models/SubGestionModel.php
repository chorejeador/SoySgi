<?php
	...
	class SubGestionModel extends CI_Model
	{
		...
		public function subgestionSearch($filtro)
		{
			...
			if ($query->num_rows() > 0) {
				foreach ($query->result_array() as $key) {
					...
					$json["data"][$i]["AgregarDocumento"] = '<a class="btn btn-primary d-inline-flex align-items-center justify-content-center"style="width:42px; height:42px; padding:0;"href="' . base_url("index.php/agregarDocumentoSubGestion/") . $key["IdSubGestion"] . '"><i class="fa-solid fa-file" style="font-size:18px; line-height:1;"></i></a>';
					$i++;
				}
			}
		...
		public function getDocumentos($id)
		{
			...
			return $this->db->get('TblDocumentosSubGestion')->result_array();
		}
