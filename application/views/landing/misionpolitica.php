...
<div class="card setting-toggle" href="#settings-offcanvas" data-bs-toggle="offcanvas">
	<div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
		...
		<a href="https://www.facebook.com/delmornic/" target="_blank"><img
				src="<?php echo base_url() ?>assets/img/facebook.png" width="26" alt=""></a>
		<a href="https://www.instagram.com/delmornic/?hl=es-la" target="_blank"><img
				src="<?php echo base_url() ?>assets/img/instagram.png" width="26" alt=""></a>
		<a href="https://www.youtube.com/@delmornicaragua932/featured" target="_blank"><img
				src="<?php echo base_url() ?>assets/img/youtube.png" width="26" alt=""></a>
	</div>
</div>
<!-- Navigation-->
	...
	<div class="container">
		...
		<div class="text-center">
			...
			<P class="text-start">Los principios de prevención, pensamiento basado en riesgos y oportunidades,
				...
				cárnicos, embutidos y ahumados.
				Cumplimos los requisitos legales y reglamentarios aplicables, en lo relacionado con Calidad, Inocuidad,
				Seguridad y Salud en el Trabajo, así como en Asuntos Ambientales.
				Para el éxito sostenible fijamos como premisa institucional, la mejora continua en el desempeño del
				Sistema de Gestión Integral, fortaleciendo las competencias de los colaboradores, a fin de garantizar la
				seguridad alimentaria, contribuir al desarrollo socioeconómico del país y al bienestar de nuestra
				comunidad y sus familias.
				Promovemos canales eficaces de comunicación, tanto internos como externos, que aseguren la comprensión y
				aplicación de esta política a todos los niveles de la organización.
			</P>
		</div>
	</div>
</section>
