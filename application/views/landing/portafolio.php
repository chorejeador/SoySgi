    ...
    <section class="page-section" id="about">
        <div class="container" style="max-width:80%;">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <form id="categoryForm">
                        ...
                        <div class="clear-filters-wrap">
                            <button type="button" class="btn btn-outline-danger" id="clearFilters"style="position:relative !important; left:72px !important;">
                            ...
                            <?php foreach ($categorias as $value): ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                        ...
                                        id="category<?= $value["IdCategoria"] ?>"
                                        name="categories[]">
                                    <label class="form-check-label category_label" for="category<?= $value["IdCategoria"] ?>">
                                        <?= $value["Descripcion"] ?>
                                    </label>
                                </div>
                            <?php endforeach; ?>
                ...
                <div class="col-md-9">
                    <table class="table table-borderless w-100" id="catImagenes">
                        <thead>
                            <tr>
                                <th></th>
                            </tr>
