...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/selec2/select2.min.css">
    </link>
...
<body id="app-container" class="menu-default show-spinner">
    <nav class="navbar fixed-top" style="background-color:#C41818!important;">
        ...
        </div><a class="navbar-logo" href="<?php echo base_url('index.php') ?>"><span class="logo d-none d-xs-block"></span> <span
